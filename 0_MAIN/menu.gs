...
function onOpen() {
  ...
  ui.createMenu('🚀 GFP')
    ...
    .addItem('🧠 Inteligência Interna', 'GFP_MENU_REPESCAR_SO_MODELO_INTERNO_16_1_18_4_2')
    .addItem('🤖 Inteligência Gemini', 'GFP_MENU_REPESCAGEM_INTELIGENTE_16_1_18_4_2')
    .addItem('🧠🤖 Inteligência Interna + Gemini', 'GFP_MENU_INTELIGENCIA_INTERNA_E_GEMINI_16_1_18_25')
    .addSeparator()
